...
public class GroqClient {
    ...
    public GroqClient(GroqConfig groqConfig) {
        ...
        int timeoutMs = groqConfig.getTimeoutSeconds() != null && groqConfig.getTimeoutSeconds() > 0 
                ? groqConfig.getTimeoutSeconds() * 1000 
                : 30000;
        factory.setConnectTimeout(3000); // 3 seconds connection timeout
        factory.setReadTimeout(timeoutMs); // read timeout from config (default 30 seconds)
